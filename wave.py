...
vV4t+0UE/G5fAN2ccz9Ug6PdAAAAAElFTkSuQmCC''')
        ...
        Label(self, text = 'Wave Generator', background = 'white', foreground = 'blue', font='papyrus 32 bold').grid(row = 1, column = 0)
    ...
    def start_server(self):
        ...
        self.insert_banner()
        self.serv.options['log'].insert('2.1', "Server started on port [%s] [%s]\nWaiting...\n" % (host, int(port)), 'deeppink')
...
''' % (time.strftime('%d/%m/%Y'),
    ...
    def open_github(self):
        webbrowser.open_new_tab('https://github.com/CesarAyalaDev/RAASNet')
...
if __name__ == "__main__":
    root = MainWindow(' ', ' ', ' ', ' ', ' ', 'n/a', 'n/a')#edit preson informantion here#
    root.mainloop()
